...
const DesktopFooter = () => {
  ...
  return (
    <nav
      className={`fixed bottom-0 left-0 w-full bg-white/80 backdrop-blur-md border-t border-gray-200 shadow-md transition-transform duration-300 hidden md:block ${
